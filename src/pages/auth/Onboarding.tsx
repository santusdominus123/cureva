...
const Onboarding: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden">
      {/* Background Image - Borobudur */}
      <div className="absolute inset-0">
        <div
          className="absolute inset-0 bg-cover bg-center bg-no-repeat"
          style={{
            backgroundImage: `url('/src/introbg/Generated Image October 20, 2025 - 10_20PM.png')`,
          }}
        />
      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        <div className="flex justify-between items-center px-6 py-4">
          ...
          <div className="flex items-center gap-2">
            <img
              ...
              alt="PKM"
              className="h-8 w-auto object-contain bg-white/95 rounded-md px-1.5 py-1 shadow-lg hover:scale-105 transition-transform duration-300 ease-out"
              onError={(e) => {
            ...
            <img
              ...
              alt="TWH"
              className="h-8 w-auto object-contain bg-white/95 rounded-full p-0.5 shadow-lg hover:scale-105 transition-transform duration-300 ease-out"
              onError={(e) => {
                e.currentTarget.style.display = "none";
              }}
            />
          ...
          {/* Skip Button */}
          <button onClick={handleSkip} className="text-sm text-slate-400 hover:text-white font-medium px-4 py-2 rounded-lg hover:bg-white/5 transition-all duration-300 ease-out">
            Skip
          </button>
        </div>
            ...
            <div key={currentStep} className="animate-slide-in-smooth">
              ...
              <div className="flex justify-center mb-6">
                <div className="relative group">
                  ...
                  `}
                  >
                    <Icon className="w-12 h-12 text-white transition-transform duration-500" strokeWidth={2} />
                  </div>
              ...
              <div className="text-center space-y-2 mb-8">
                ...
                <h1 className="text-4xl sm:text-5xl font-bold text-white leading-tight animate-fade-in-up animation-delay-100 transition-all duration-500 ease-out">{currentStepData.title}</h1>

                {/* Description - Close to Title */}
                <p className="text-base text-slate-300 leading-relaxed max-w-md mx-auto pt-2 animate-fade-in-up animation-delay-200 transition-all duration-500 ease-out">{currentStepData.description}</p>
              </div>
                ...
                {steps.map((step, index) => (
                  <button
                    ...
                    className={`
                      ...
                      ${index === currentStep ? `w-8 h-2 bg-gradient-to-r ${currentStepData.color} shadow-lg scale-110` : "w-2 h-2 bg-slate-700 hover:bg-slate-600 hover:scale-125"}
                    `}
        ...
        <div className="py-4 px-6">
          <p className="text-xs text-slate-500 text-center">© 2025 Cureva · Program Kreativitas Mahasiswa</p>
        </div>
      </div>
